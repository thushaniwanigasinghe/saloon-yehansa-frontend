...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 font-sans pb-20">
      ...
      <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10">
          <h1 className="text-5xl md:text-6xl font-light text-white uppercase tracking-widest mb-6">
            Terms & <span className="font-serif italic text-yellow-500 lowercase">Conditions</span>
          </h1>
          <p className="text-gray-400 font-light text-sm tracking-[0.3em] uppercase">Last Updated: April 2026</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/4 hidden lg:block">
            <div className="sticky top-28 bg-neutral-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
              <h3 className="text-white font-serif italic text-xl mb-6">Contents</h3>
                  ...
                  <li key={item.id}>
                    <button
                      ...
                      className={`flex items-center gap-3 text-sm font-light tracking-wide transition-all duration-300 w-full text-left ${
                        activeSection === item.id ? 'text-yellow-500 translate-x-2' : 'text-gray-400 hover:text-white'
                      }`}
                    >
          ...
          <div className="lg:w-3/4">
            <div className="bg-neutral-900/30 border border-white/5 rounded-3xl p-8 md:p-12 backdrop-blur-md">
              <div className="space-y-16 text-gray-300 font-light leading-loose text-base md:text-lg">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-serif italic text-white">1. Introduction</h2>
                  </div>
                ...
                <section id="booking" className="scroll-mt-32">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-serif italic text-white">2. Appointments & Booking</h2>
                  </div>
                  ...
                  <div className="bg-black/40 border border-white/5 rounded-xl p-6">
                    <ul className="space-y-4 text-gray-400">
                      <li className="flex items-start gap-3">
                        ...
                        <span>Please arrive at least <strong className="text-white font-normal">10 minutes prior</strong> to your scheduled appointment time to ensure a full luxury experience.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 mt-2.5 flex-shrink-0"></span>
                ...
                <section id="cancellation" className="scroll-mt-32">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-serif italic text-white">3. Cancellation Policy</h2>
                  </div>
                  <p className="text-gray-400">
                    We value your time and ours. If you need to cancel or reschedule your appointment, we require a minimum of <strong className="text-white font-normal">24 hours' notice</strong>. 
                ...
                <section id="refunds" className="scroll-mt-32">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-serif italic text-white">4. Refunds & Satisfaction</h2>
                  </div>
                  <p className="text-gray-400">
                ...
                <section id="safety" className="scroll-mt-32">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-serif italic text-white">5. Health & Safety</h2>
                  </div>
                  <p className="text-gray-400">
